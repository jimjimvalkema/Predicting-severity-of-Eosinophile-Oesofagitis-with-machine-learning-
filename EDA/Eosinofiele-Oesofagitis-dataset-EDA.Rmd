...
The algorithm should be able to run on a consumer desktop and but doesn't need to be too fast when classefying. This because it is likly that only one patient will be avaluated at the time so accuracy is far more important then speed.
